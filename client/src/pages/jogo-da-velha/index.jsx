...
export default function Home() {
	...
	const vencedor = cells => {
		...
		for (let caso in casos) {
			casos[caso].forEach(possi => {
				if (cells[possi[0]] === ' ' || cells[possi[1]] === ' ' || cells[possi[2]] === ' ') {
					//um dos valores é vazio, logo, nada será feito
				} else if (cells[possi[0]] === cells[possi[1]] && cells[possi[2]] === cells[possi[1]]) {
	...
	const Celula = ({ num }) => {
		//dentro dos parênteses, o componente recebe o parâmetro de nome num. O mesmo que props.num
